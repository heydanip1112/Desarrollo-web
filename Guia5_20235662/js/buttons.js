...
function confirmacion() {
    //Los valores que puede almacenar la confirmacion son true o false
    let confirmacion = confirm("¿Desea salir de la Sesión?");
    /* para imprimir una variable en una cadena podemos utilizar las comillas simples inversas `` y luego
...
function capturarDatos() {
    ...
    let edad = promt("¿Cuál es su edad?", 0);
...
function dibujarParrafo() {
    ...
    /* Utilizaremos la API DOM para acceder al elemento <p id="idParrafo"></p> que
    hemos creado en nuestro documento HTML */
